    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(help_text='should be {module_path}.{class_name} of the service bridge class', max_length=255)),
                ('target', models.CharField(help_text='should be {app_label}.{mode_name} of the target model', max_length=255)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('action', models.CharField(choices=[('pull', 'Pull'), ('push', 'Push')], default='pull', max_length=8)),
                ('data_map', models.JSONField(blank=True, default={}, help_text='map reference fields to target fields - only fields specified here will be affected by this action. Leave empty to use the default definitions for the model, if they exist.', null=True)),
            ],
            options={
